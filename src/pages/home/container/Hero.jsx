  ...
  return (
    <section className="container mx-auto flex flex-col px-5 py-5 lg:flex-row">
      <div className="mt-10 lg:w-1/2">
        <h1
          className="
            font-roboto text-4xl text-center font-bold text-dark-soft
            md:text-5xl lg:text-left lg:max-w-[540px]
            "
        >
        ...
        <div className="flex flex-col gap-y-2.5 mt-10 relative">
          ...
          <button
            className="
          w-full bg-primary text-white font-semibold rounded-lg px-5 py-3 md:absolute 
          md:right-2 md:top-1/2 md:-translate-y-1/2 md:w-fit md:py-2"
          >
            Search
          </button>
        </div>
