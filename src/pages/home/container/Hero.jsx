      ...
      <section className="container mx-auto flex flex-col px-5 py-5 lg:flex-row">
        <div className="mt-10 lg:w-1/2">
          ...
          <p className="text-dark-light mt-4 text-center md:text-xl lg:text-base xl:text-xl lg:text-left">
            ...
            quote from a featured article/blogpost. Yeah. That could be cool!
            Like a featured quote of an article. Yeah!
          </p>
        </div>
      ...
      <section className="container mx-auto px-5 py-5">
        <div className="flex flex-col gap-y-2.5 mt-10 lg:mt-6 xl:mt-10 relative">
          <div className="relative flex items-center">
            ...
            <button
              className="
            bg-primary text-white font-semibold rounded-lg px-5 py-3 
            md:py-4 whitespace-nowrap h-full"
            >
              Search
            </button>
          </div>
